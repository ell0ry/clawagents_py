<p align="center">
  ...
  <p align="center">
    <img src="https://img.shields.io/badge/version-6.20.17-blue" alt="Version">
...
| **Python package** | **v6.20.17** | This library — seatbelt /dev/null + sandbox hints · `pip install -U 'clawagents[bedrock]'` | [PyPI](https://pypi.org/project/clawagents/) · [Release](https://github.com/x1jiang/clawagents_py/releases) |
...
> **Version 6.20.17** — Seatbelt allows ``/dev/null``; clearer gcloud/home-config sandbox hints (July 2026).
>
