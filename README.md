<p align="center">
  ...
  <p align="center">
    <img src="https://img.shields.io/badge/version-6.20.16-blue" alt="Version">
...
| **Python package** | **v6.20.16** | This library — skill auto-continuation · `pip install -U 'clawagents[bedrock]'` | [PyPI](https://pypi.org/project/clawagents/) · [Release](https://github.com/x1jiang/clawagents_py/releases) |
...
> **Version 6.20.16** — snapshot_diff ``showing 40 of N`` file-cap note (July 2026).
>
