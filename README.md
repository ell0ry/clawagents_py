<p align="center">
  ...
  <p align="center">
    <img src="https://img.shields.io/badge/version-6.20.12-blue" alt="Version">
...
| **Python package** | **v6.20.12** | This library — Mantle GPT-5.6 temperature + model-id fix · `pip install -U 'clawagents[bedrock]'` | [PyPI](https://pypi.org/project/clawagents/) · [Release](https://github.com/x1jiang/clawagents_py/releases) |
...
> **Version 6.20.12** — Mantle GPT-5.6 / Responses omit deprecated ``temperature``; bare Luna ids normalize to ``openai.gpt-5.6-*`` (July 2026).
>
