<p align="center">
  ...
  <p align="center">
    <img src="https://img.shields.io/badge/version-6.20.9-blue" alt="Version">
...
| **Python package** | **v6.20.9** | This library — capabilities contract + workspace-scoped artifacts · `pip install -U 'clawagents[bedrock]'` | [PyPI](https://pypi.org/project/clawagents/) · [Release](https://github.com/x1jiang/clawagents_py/releases) |
...
> **Version 6.20.9** — Capabilities contract + workspace-scoped tool artifacts (July 2026).
>
